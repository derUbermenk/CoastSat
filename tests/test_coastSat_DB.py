...
def test_retrieve_shoreline_from_db():
    shoreline_baseline = [
    ...
    expected_shoreline = Shoreline()
    expected_shoreline.sitename="TEST1",
    expected_shoreline.loc="test loc, testing",
    expected_shoreline.baseline=shoreline_baseline,
    expected_shoreline.area=shoreline_area
    ...
    shoreline = csRunner.retrieve_shoreline()
    assert shoreline.sitename, expected_shoreline.sitename
    assert shoreline.loc, expected_shoreline.loc
    assert shoreline.baseline, expected_shoreline.baseline
    assert shoreline.area, expected_shoreline.area
